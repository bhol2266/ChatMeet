            ...
            for (int i = userListTemp.size(); i < userList.size(); i++) {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (activityName != null && activityName.equals("com.bhola.saxchat2.MainActivity")) {
                            playSentAudio();
                        }
                    }
                }, delayTime);
...
class MessengeItemsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
                        ...
                        public void run() {
                            ...
                            new Handler().postDelayed(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    if (activityName != null && activityName.equals("com.bhola.saxchat2.ChatScreen_User")) {
    ...
    private void setMessageCount(ArrayList<UserBotMsg> userBotMsg, TextView messageCount, String userName) {
        ...
        if (Fragment_Messenger.currentActiveUser.equals(userName) && activityName != null && activityName.equals("com.bhola.saxchat2.ChatScreen_User")) {
